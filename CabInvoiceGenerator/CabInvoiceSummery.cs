...
namespace CabInvoiceGenerator
{
    public class CabInvoiceSummery
    {
        ...
        public CabInvoiceSummery(int numberOfRides, double totalFare)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            if (!(obj is CabInvoiceSummery)) return false;

            CabInvoiceSummery inputObject = (CabInvoiceSummery)obj;
